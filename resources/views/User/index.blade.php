...
@section('content')
    ...
    <div class="container-fluid mg-t-40">
        <div class="mg-t-20 mg-l-20 d-align-center">
            <img @isset($user->profil_image) src="{{ asset($user->profil_image) }}" @else src="{{ asset('img/default_picture_user.png') }}" @endisset alt="Photo de profil de {{ $user->name }}" style="width:100px;height:100px;border-radius:70px;"/>
            <div>
